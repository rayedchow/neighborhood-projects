              ...
              <CardContent>
                ...
                <div className="flex justify-between mt-4 text-center">
                  <div>
                    ...
                    <p className="font-medium">
                      {Math.round(
                        getCurrentTrend()?.accuracy.reduce((sum, val) => sum + val, 0)! / 
                        getCurrentTrend()?.accuracy.filter(val => val > 0).length || 0
                      )}%
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="font-medium">
                      {getCurrentTrend()?.questionCounts.reduce((sum, val) => sum + val, 0)}
                    </p>
                  </div>
                  <div>
