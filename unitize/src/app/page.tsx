  ...
  return (
    <div className="space-y-16">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        {/* Wave divider */}
        <div className="absolute bottom-0 left-0 right-0 h-12 sm:h-24 overflow-hidden">
          <svg className="absolute bottom-0 w-full h-full text-white dark:text-neutral-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
