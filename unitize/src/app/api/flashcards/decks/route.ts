...
export async function GET(request: NextRequest) {
  ...
  if (isPublic) {
    const response = FlashcardService.getPublicDecks(limit, offset);
  ...
  const response = FlashcardService.getUserDecks(userId);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = FlashcardService.createDeck(
      userId,
      name,
      description,
      courseId,
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const response = FlashcardService.updateDeck(userId, deckId, updates);
...
export async function DELETE(request: NextRequest) {
  ...
  const response = FlashcardService.deleteDeck(userId, deckId);
